...
class Stripe_Object implements ArrayAccess
{
  ...
  public function __get($k)
  {
    if (array_key_exists($k, $this->_values)) {
      ...
      error_log("Stripe2 Notice: Undefined property of $class instance: $k.  HINT: The $k attribute was set in the past, however.  It was then wiped when refreshing the object with the result returned by Stripe2's API, probably as a result of a save().  The attributes currently available on this object are: $attrs");
      return null;
    } else {
      $class = get_class($this);
      error_log("Stripe2 Notice: Undefined property of $class instance: $k");
      return null;
    }
  }
